...
export function JamSetupSheet({
  ...
  return (
    <>
      ...
      {/* No takes on a phone: a take is your playing mixed with the band,
          and the microphone it records you through is not part of a mobile
          build (plan §1). Absent, not disabled — M08. */}
      {!IS_MOBILE && (
        <>
