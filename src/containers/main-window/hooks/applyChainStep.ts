...
import type { ChainStep, Subdivision } from "../../../types";

/**
 * Push a step's configuration onto the engine.
 *
 * Two callers need this and they must agree exactly: the runner applies a
 * step when the chain lands on it, and selecting a step in the track applies
 ...
 */
export function applyChainStep(step: ChainStep): void {
