...
// `DrillRun` moved to its own module: drills ship on mobile, evaluation
// does not (M01). Re-exported so every existing `session::DrillRun` path
// still resolves.
pub use crate::drill::{DrillReach, DrillRun, MAX_DRILL_RUN_HISTORY};
